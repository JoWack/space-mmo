...
| .NET Framework SDK 4.8 | ✅ installed — editor builds, 58 automation tests pass |
...
58 automation tests passing. One thing still blocks part of M2: dedicated server targets
