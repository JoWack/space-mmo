...
| .NET Framework SDK 4.8 | ✅ installed — editor builds, 63 automation tests pass |
...
63 automation tests passing. One thing still blocks part of M2: dedicated server targets
