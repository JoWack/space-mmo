...
| .NET Framework SDK 4.8 | ✅ installed — editor builds, 50 automation tests pass |
...
50 automation tests passing. One thing still blocks part of M2: dedicated server targets
