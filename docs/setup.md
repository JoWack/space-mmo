...
| .NET Framework SDK 4.8 | ✅ installed — editor builds, 36 automation tests pass |
...
36 automation tests passing. One thing still blocks part of M2: dedicated server targets
